...
TEST_F(PixelTest, hasAscendingOrderComparator) {
    ...
    verifyOrderUsingAscendingComparator({
        Pixel<unsigned char>(left, up, deep),
        Pixel<unsigned char>(left, down, deep),
        Pixel<unsigned char>(right, up, deep),
        Pixel<unsigned char>(right, down, deep),
...
TEST_F(PixelTest, hasDescendingOrderComparator) {
    const unsigned int left = 102;
    const unsigned int right = 149;
    const unsigned int up = 147;
    const unsigned int down = 148;
    const unsigned char deep = 20;
    const unsigned char shallow = 21;

    verifyOrderUsingDescendingComparator({
        Pixel<unsigned char>(left, up, deep),
        Pixel<unsigned char>(left, down, deep),
        Pixel<unsigned char>(right, up, deep),
        Pixel<unsigned char>(right, down, deep),
